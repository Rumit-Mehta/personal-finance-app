...
- Bank statements, Excel files, Monzo JSON, and future import sources should normalize into the shared finance data model.
...
- Existing spreadsheet creation/export lives in `src/data/createSpreadsheetTemplate.js` and `src/data/updateSpreadsheet.js`.
