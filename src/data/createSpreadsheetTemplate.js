...
const SHEETS = {
  ...
  accounts: {
    ...
    rows: [["acc_001", "Current Account", "current", "", "GBP", 0, ""]],
  },
  transactions: {
    name: "Transactions",
    columns: [
...
function createDummyAccounts() {
  return [
    ["acc_001", "Monzo Current", "current", "Monzo", "GBP", 1250, ""],
    ["acc_002", "Starling Bills", "current", "Starling", "GBP", 850, ""],
    ["acc_003", "Barclays Salary", "current", "Barclays", "GBP", 2100, ""],
    ["acc_004", "Chase Spending", "current", "Chase", "GBP", 600, ""],
    ["acc_005", "Emergency Fund", "savings", "Marcus", "GBP", 9000, ""],
    ["acc_006", "Holiday Savings", "savings", "Monzo", "GBP", 2400, ""],
    ["acc_007", "House Deposit", "savings", "Nationwide", "GBP", 18500, ""],
    ["acc_008", "Cash ISA", "isa", "Virgin Money", "GBP", 7000, ""],
    ["acc_009", "Amex Cashback", "creditCard", "American Express", "GBP", 0, ""],
    ["acc_010", "Barclaycard", "creditCard", "Barclays", "GBP", 0, ""],
    ["acc_011", "Joint Account", "current", "Lloyds", "GBP", 3200, ""],
    ["acc_012", "Business Account", "business", "Revolut", "GBP", 4800, ""],
  ];
}
